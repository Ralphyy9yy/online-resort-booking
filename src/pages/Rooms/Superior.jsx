...
import { motion } from "framer-motion";
 // Updated import path
import superiorLogo from "../../assets/SuperiorSuite/Superior.png";  // Updated import path
import { FaHome, FaBed } from "react-icons/fa";
import features from "../../assets/features.png";  // Updated import path
import superior1 from "../../assets/SuperiorSuite/superior1.jpg";  // Updated import path
import superior2 from "../../assets/SuperiorSuite/superior2.jpg"; 
import superior3 from "../../assets/SuperiorSuite/superior3.jpg"; 
import superior4 from "../../assets/SuperiorSuite/superior4.jpg"; 
import superior5 from "../../assets/SuperiorSuite/superior5.jpg"; 
import superior6 from "../../assets/SuperiorSuite/superior6.jpg"; 
import superiorBG from "../../assets/SuperiorSuite/superiorBG.jpg"
...
export default function Home() {
  const images = [superior1, superior2, superior3, superior4, superior5, superior6];
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${superiorBG})` }}
      >
        {/* Image Animation */}
        <motion.img
          src={superiorLogo}
      ...
      {/* Feature Details */}
      <motion.div
        className="absolute bottom-70 left-5 md:left-20 text-black flex flex-col gap-4 p-4 rounded-lg backdrop-blur-sm bg-white bg-opacity-10 shadow-lg"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-white p-6 md:p-12 w-full space-y-8 md:space-y-0">
        ...
        <div className="md:w-1/2 max-w-lg text-center md:text-left px-4">
          ...
          <ul className="list-disc pl-6 md:pl-9">
            ...
            <li>Balcony/Terrace with 1 table, 2chairs</li>
            <li>Whirlpool</li>
