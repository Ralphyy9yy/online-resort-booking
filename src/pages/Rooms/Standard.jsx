...
import image1 from "../../assets/Standard.jpg"; // Updated import path
import frame2 from "../../assets/frame2.png";  // Updated import path
import { FaHome, FaBed } from "react-icons/fa";
import features from "../../assets/features.png";  // Updated import path
import standard1 from "../../assets/standard1.jpg";  // Updated import path
import standard2 from "../../assets/standard2.jpg";  // Updated import path
import standard3 from "../../assets/standard3.jpg";  // Updated import path
import standard4 from "../../assets/standard4.jpg";  // Updated import path
import standard5 from "../../assets/standard5.jpg";  // Updated import path
import standard6 from "../../assets/standard6.jpg";  // Updated import path
import display2 from "../../assets/display2.jpg";  // Updated import path

export default function Home() {
  const images = [standard1, standard2, standard3, standard4, standard5, standard6];
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-white p-6 md:p-12 w-full space-y-8 md:space-y-0">
        ...
        <div className="md:w-1/2 max-w-lg text-center md:text-left px-4">
          ...
          <ul className="list-disc pl-6 md:pl-9">
            <li>Bed Type: one double or two twins</li>
